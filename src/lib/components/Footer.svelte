  ...
  <div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row justify-between items-center">
      ...
      <div class="mb-4 md:mb-0">
        <a href="/" class="text-2xl font-bold tracking-wide text-emerald-500 hover:text-emerald-400">
          KYCID
        </a>
      ...
      <div class="flex space-x-4 mt-4 md:mt-0">
        <a href="https://twitter.com/KYCID" target="_blank" rel="noopener noreferrer" aria-label="Twitter" class="hover:text-emerald-400">
        ...
        <a href="https://linkedin.com/company/KYCID" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="hover:text-emerald-400">
          <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <a href="https://github.com/KYCID" target="_blank" rel="noopener noreferrer" aria-label="GitHub" class="hover:text-emerald-400">
          <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
